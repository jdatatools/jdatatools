...
/**
 * Represents the data returned by {@link java.sql.DatabaseMetaData#getCrossReference(String, String, String, String, String, String)}.
 */
@Data
public class SqlCrossReference {
    ...
    /**
     * Sequence number within foreign key( a value of 1 represents the first column of the foreign key, a value of 2 represents the second column within the foreign key).
     */
    @Column(name = "KEY_SEQ")
